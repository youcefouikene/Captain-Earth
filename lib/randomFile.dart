...
//   Widget build(BuildContext context) {
//     if(clickRight){
//       playQqs('quiz/question${widget.continentNumber+1}_${qqsBank[currentQqs].number + 1}', 'quiz/question${widget.continentNumber+2}_${qqsBank[currentQqs].number + 1}');
...
//       onTap: () {
//         playQqs('quiz/question${continentNumber+1}_${qqsBank[question].number + 1}', 'quiz/question${continentNumber+2}_${qqsBank[question].number + 1}');
//       },
//       child: Container(
...
//   );
//   player2.play(
//     AssetSource('sounds/questions/Oceania.mp3',),
//   );
