...
class SignUp1 extends StatefulWidget {
  double screenWidth;
  double screenHeight;
  SignUp1({required this.screenWidth, required this.screenHeight, Key? key}) : super(key: key);
          ...
          children: [
            ...
            Positioned(
              ...
              SizedBox(
                ...
                height:  (282/360) * _screenHeight,
                child:
                Container(
                  padding: EdgeInsets.symmetric( horizontal: (31 / 800) * _screenWidth ),
                  decoration:  BoxDecoration (
                    borderRadius:  BorderRadius.circular( (52/360) * _screenHeight ),
                    border:  Border.all(color: const Color.fromRGBO(51, 129, 74, 1), style: BorderStyle.solid, width: (3/800) * _screenWidth),
                    color:  Colors.white,
                  ),
                  child: Form(
                    key: _formKey,
                      ...
                      children: <Widget>[
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            prefixIcon: Padding(
                              ...
                              child: Icon(Icons.mail_outline, size: (28 / 800) * _screenWidth, color: const Color.fromRGBO(96, 94, 94, 1)),
                            ),
                          ...
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                              return 'Entrez l\'email du parent ';
                            }
                            return null;
                          },
                        ),
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            prefixIcon: Padding(
                              padding: EdgeInsets.only(left: (26.42/800)*_screenWidth),
                              child: Icon(Icons.person_outline_outlined, size: (30 / 800) * _screenWidth,color: const Color.fromRGBO(96, 94, 94, 1)),
                            ),
                            enabledBorder: OutlineInputBorder(
                              borderSide: const BorderSide(
                                color: Color.fromRGBO(238, 236, 235, 1),
