  ...
  Widget build(BuildContext context) {
    ...
    return _isFinished!
        ? EndGamePage(
            ...
            score: _score,
            station: 'Station 05',
            refreshPath: '/AmeriqueNordMiniJeu')
        : Scaffold(
            body: Container(
              width: size.width,
              height: size.height,
                ...
                child: Stack(
                  children: [
                      ...
                      child: Column(
                        children: <Widget>[
                          Positioned(
                            ...
                            child: Padding(
                                padding:
                                    EdgeInsets.only(bottom: wid * (10 / 800)),
                                child: _time > 0
                    ...
                    Positioned(
                      ...
                      top: MediaQuery.of(context).size.height * (8 / 360),
                      child: Column(
                        children: [
                          ...
                          SizedBox(
                            height:
                                MediaQuery.of(context).size.height * (12 / 360),
                          ),
                          Stack(alignment: Alignment.center, children: [
                            Container(
                              width:
                    ...
                    Positioned(
                      ...
                      top: MediaQuery.of(context).size.height * (10 / 360),
                      child: Container(
                          child: Stack(
