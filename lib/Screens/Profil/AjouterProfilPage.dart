      ...
      body: Stack(
        children: [
          ...
          Stack(children: [
              ...
              child: Container(
                  ...
                  child: Column(children: [
                    TextFormField(
                      controller: _nameController,
                      textAlign: TextAlign.center,
                      cursorColor: const Color.fromRGBO(19, 78, 73, 1),
                      decoration: InputDecoration(
            ...
            Positioned(
              left: MediaQuery.of(context).size.width * 280 / 800,
              top: MediaQuery.of(context).size.height * 259 / 360,
              child: Container(
                width: MediaQuery.of(context).size.width * (164 / 800),
                height: MediaQuery.of(context).size.height * (39 / 360),
                decoration: BoxDecoration(
