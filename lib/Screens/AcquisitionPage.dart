...
class AcquisitionPage extends StatefulWidget {
  ...
  int giveTotal(){
    return ptAfrique+ptAsie+ptAfrique+ptEurope+ptAmeriqueNord+ptAmeriqueSud;
  }
}
                  ...
                  children: [
                    Container(
                      ...
                      child: Stack(
                        children: [
                        Container(
                          width:wid*(widget.ptOcianie*widthBloc/pointsMax)/800 ,//il change suivant un pourcentage de points 
                          height: het*41/360,
                          decoration: BoxDecoration(
                    ...
                    Container(
                      ...
                      child: Stack(
                        children: [
                         ...
                         Container(
                          width:(wid)*(widget.ptAsie*widthBloc/pointsMax)/800 ,//il change suivant un pourcentage de points 
                          height: het*41/360,
                          decoration: BoxDecoration(
                             color:const Color.fromRGBO(104, 216, 104, 1),
                             borderRadius: BorderRadius.circular(wid*14/800),
                    ...
                    Container(
                      ...
                      child: Stack(
                        ...
                        Container(
                          width:wid*(widget.ptAfrique*widthBloc/pointsMax)/800 ,//il change suivant un pourcentage de points 
                          height: het*41/360,
                          decoration: BoxDecoration(
                             color:const Color.fromRGBO(104, 216, 104, 1),
                             borderRadius: BorderRadius.circular(wid*14/800),
                  ...
                  children: [
                    Container(
                      ...
                      child: Stack(
                        ...
                        Container(
                          width:wid*(widget.ptEurope*widthBloc/pointsMax)/800 ,//il change suivant un pourcentage de points 
                          height: het*41/360,
                          decoration: BoxDecoration(
                             color:const Color.fromRGBO(104, 216, 104, 1),
                             borderRadius: BorderRadius.circular(wid*14/800),
                    ...
                    Container(
                      ...
                      child: Stack(
                        ...
                        Container(
                          width:wid*(widget.ptAmeriqueNord*widthBloc/pointsMax)/800 ,//il change suivant un pourcentage de points 
                          height: het*41/360,
                          decoration: BoxDecoration(
                             color:const Color.fromRGBO(104, 216, 104, 1),
                             borderRadius: BorderRadius.circular(wid*14/800),
                        ...
                        Center(
                          child: Text("Energies renouvlables",
                            style: TextStyle(
                            color:const Color.fromRGBO(0, 0, 0,1),
                            fontFamily: "Atma",
                            fontSize: wid*22/800,
                    ...
                    Container(
                      ...
                      child: Stack(
                        ...
                        Container(
                          width:(wid)*(widget.ptAmeriqueSud*widthBloc/pointsMax)/800 ,//il change suivant un pourcentage de points 
                          height: het*41/360,
                          decoration: BoxDecoration(
                             color:const Color.fromRGBO(104, 216, 104, 1),
                             borderRadius: BorderRadius.circular(wid*14/800),
                  ...
                  Stack(
                    children: [
                      Container(
                       ...
                       Container(
                            width:wid*(acquisitionTotale*584/total)/800 ,//il change suivant un pourcentage de points 
                            height: het*7/360,
                            decoration: BoxDecoration(
