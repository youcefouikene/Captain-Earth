...
class DemandePage extends StatefulWidget {
  double screenWidth;
  double screenHeight;
  DemandePage({required this.screenWidth, required this.screenHeight, Key? key})
      : super(key: key);
    ...
    return Scaffold(
      body: Container(
        padding: EdgeInsets.only(
            left: (29 / 800) * _screenWidth, top: (24 / 360) * _screenHeight),
        ...
        child: Stack(
          children: [
              ...
              children: [
                InkWell(
                  ...
                  child: CustomContainer(
                    ...
                    heightContainer:
                        MediaQuery.of(context).size.width * 0.04875,
                    icon: _icone,
                  ),
                ),
                SizedBox(
                  height: MediaQuery.of(context).size.height * (24 / 360),
                ),
                InkWell(
                  onTap: () {},
                  onHover: (value) {
                          ...
                          children: [
                            GestureDetector(
                                ...
                                child: CustomContainerText(
                                    colorTop:
                                        const Color.fromRGBO(232, 69, 96, 1),
                                    widthContainer: (82 / 800) * _screenWidth,
                                    heightContainer: (49 / 360) * _screenHeight,
                                    texte: 'OUI',
            ...
            Positioned(
              ...
              child: Image.asset(
                'assets/avatar/captain_question_1.png',
                width: 0.174 * _screenWidth,
              ),
            ),
          ],
        ),
