...
class _WelcomePageState extends State<WelcomePage> {
  List<List<String>> listeGlobale = [
    [
      ...
      'Allons-y !',
      'à travers cette mission, nous en\napprendrons plus sur la pollution de\nl\'eau et ses effets nocifs sur la\nplanete'
    ],
    [
      'Bienvenue en Asie',
      'Ici ou se trouve la plupart des usines\ndes sociétés industrielle !\nAvez-vous une idée de ce que sera \nnotre mission ? ',
      'assets/images/asie/Background_Asia.png',
      'Allons-y !',
      'à travers cette mission, nous en \napprendrons plus sur la pollution de\nl\'aire et ses effets nocifs sur la\nplanete'
    ],
    [
      'Bienvenue en Afrique',
      'Plus de 1000 mammifères et 2600 \nespèces d\'oiseaux vivent ici !\nAvez-vous une idée de ce que sera\nnotre mission ? ',
      'assets/images/afrique/Background_Africa_1.png',
      'Allons-y !',
      ' à travers cette mission, nous en\napprendrons plus sur les\nanimaux en danger et comment les\npréservés !'
    ],
    [
      'Benvenue en Europe',
      'Ici  48 % des déchets ont été\nrecyclés l\'an dernier!\nAvez-vous une idée de ce que sera\nnotre mission ? ',
      'assets/images/europeBackground.png',
      'Allons-y !',
      'à travers cette mission, nous en\napprendrons plus sur le recyclage des déchets et comment peut-on \nl\'appliquer au quotidien  !',
    ],
    [
      'Bienvenue en Amerique du nord',
      'Ici les énergies renouvelables représentaient environ 12,4 % de l\'énergie primaire. Avez-vous une idée de ce que sera notre mission ? ',
      'assets/images/ameriqueNord/Background_NorthAmerica.png',
      'Allons-y !',
      'à travers cette mission, nous en\napprendrons plus sur les\nénergies  renouvelables et leurs\nimpact positive sur la planète'
    ],
    [
      'Bienvenue en Amerique du sud',
      ' Ici la moitié de la surface du\ncontinent est boisée !\nAvez-vous une idée de ce que sera\nnotre mission ? ',
      'assets/images/ameriqueSud/Background_SouthAmerica_1.png',
      'Allons-y !',
      'à travers cette mission, nous en\napprendrons plus sur la\ndéforestation et comment peut-on\npréserver la flore !'
    ],
  ];
  int index = 0;
        ...
        Container(
          decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage(listeGlobale[numStation][2]),
              fit: BoxFit.cover,
            ),
          ),
        ),
