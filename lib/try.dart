              ...
              children: [
                ...
                Stack(
                  ...
                  children: [
                    ...
                    IconButton(
                      onPressed: () async{
                        Future<UserProgress> userProgressUpdate = getSQFLite("guest");
                        userProgress = await userProgressUpdate;
                        print('AVATAR  : ${userProgress.avatar}');
                        print('NAME    : ${userProgress.email}');
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Profil(
                                    username: userProgress.email,
                                    pathPhoto:
                                        "assets/images/player_avatars/avatar${userProgress.avatar}.png")));
                      },
  ...
  Widget build(BuildContext context) {
    if (widget.isOpened) {
      if (widget.station.stationProgress.stationIndex == 0) {
        return InkWell(
            onTap: () async {
              Navigator.of(context).pushNamed('/WelcomeStation', arguments: {
                'numStation': '0',
